...
{
	$("#myNetwork").mouseenter(function(){
  		alert("You entered mentors!");
	});
	// for( var i =0 ; i < 65 ; i++)
	// {
		// $('#displayMentorInfo').append( "Lots of random length of text i wish was easier than this but this will work brain fart");
	// }
}
